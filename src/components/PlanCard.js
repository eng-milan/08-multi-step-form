...
function PlanCard({ image, planName, monthlyRate, yearlyRate, isYearly, handlePlanClick, selectedPlan }) {
    const cardClassNames = classNames("flex items-start mb-[15px] px-[20px] py-[20px] border rounded-xl cursor-pointer hover:border-[#02295a] lg:flex-col lg:w-[170px]", {
...
return <div
    ...
    <img className="mr-[20px] w-[55px] lg:mb-[40px]" src={image} alt="arcade" />
